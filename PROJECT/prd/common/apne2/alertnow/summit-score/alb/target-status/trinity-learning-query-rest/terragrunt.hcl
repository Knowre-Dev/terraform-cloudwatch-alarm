...
inputs = {
  alarm_name          = "[AlertNow] Target Availability Status [SummitScore]-[LearningHistory]"
  alarm_description   = "[AlertNow] Target Availability Status [SummitScore]-[LearningHistory]"
