  ...
  event_pattern = <<PATTERN
{
  ...
  "resources": [
    ...
    "arn:aws:rds:ap-northeast-2:468720534852:cluster:sl-jarvis-auth-red-prd",
    "arn:aws:rds:ap-northeast-2:468720534852:cluster:sl-jarvis-learning-red-prd",
    "arn:aws:rds:ap-northeast-2:468720534852:cluster:sl-jarvis-payment-red-prd",
